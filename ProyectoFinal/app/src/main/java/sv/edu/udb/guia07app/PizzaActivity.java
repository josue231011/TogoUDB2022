...
public class PizzaActivity extends AppCompatActivity {
    ...
    private void inicializar() {
        ...
        googleSignInClient = GoogleSignIn.getClient(PizzaActivity.this
        ...
        listaProductos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder ad = new AlertDialog.Builder(PizzaActivity.this);
                ...
                ad.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        PizzaActivity.refCarrito.push().setValue(carrito);

                        Toast.makeText(PizzaActivity.this,
        ...
        consultaOrdenada.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdaptadorVista adapter = new AdaptadorVista(PizzaActivity.this,
                        productos);
