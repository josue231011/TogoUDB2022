		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Logo -->
						<h1><a href="index.html" id="logo">To <em>Go UDB</em></a></h1>
							...
							<ul>
								...
								<li>
									<ul>
										...
										<li><a href="#mockups">To go UDB</a></li>
			...
			<!-- Highlights -->
				<section id="nosotros" class="wrapper style1">
					<div class="container">
						<div class="row gtr-200">
							<section class="col-4 col-12-narrower">
								<div class="box highlight">
									...
									<h3>Mision</h3>
									<p>Proporcionar ala poblacion y sociedad una herramienta que les facilite adiquirir alimentos de 
									primera necesidad.</p>
								</div>
							</section>
							<section class="col-4 col-12-narrower">
								<div class="box highlight">
									...
									<h3>Vision</h3>
									<p>Crear una aplicacion escalable , que sea de mucha ayuda tanto a nivel nacional como Internacional</p>
								</div>
							</section>
							<section class="col-4 col-12-narrower">
								<div class="box highlight">
									...
									<h3>Objetivo</h3>
									<p>Una Aplicacion con facilidad de uso para todas las edades , con una interaccion de primer nivel </p>
								</div>
							</section>
						</div>
					</div>
...
<section id="mockups" class="wrapper style2">
					<div class="container">
						<header class="major">
